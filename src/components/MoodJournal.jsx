            ...
            {logs.length === 0 ? (
                ...
                <div className="journal-entries">
                    ...
                    >
                                    ...
                                    {entry.gratitude_entry && (
                                        <div className="mb-3 p-3 rounded" style={{ 
                                            ...
                                            <div className="mb-1 fw-medium" style={{
                                                fontSize: '0.95rem',
                                                letterSpacing: '0.5px',
                                                color: '#e06b9f'  // Changed from text-warning to a medium pink
                                            }}>
                        ...
                        <Card.Footer className="bg-white text-end border-top-0 py-3">
                        <Button variant="outline-warning" className="rounded-pill me-2" size="sm">
                            <i className="bi bi-pencil me-1"></i>
                            Edit
                        </Button>
                        <Button variant="outline-danger" className="rounded-pill" size="sm">
