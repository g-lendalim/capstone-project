...
export default function AlarmCard ({ alarm, handleEdit, handleDelete, handleAlarmRing, checkedItems, handleCheck }) {
    const getFullDateTime = (alarm) => {
        if (alarm.type === 'Visit' && alarm.reminderTime) {
          return alarm.reminderTime;
        }
    ...
    useAlarm(triggerTime, () => handleAlarmRing(alarm));  
